...
# for alpha1 = 0.6: 
    # at p1 = 0.5, 0.6, two patches each with 0.1 and 0.9 specialists
    # at p1 = 0.7, one patch with 0.1 and 0.9, two patches with just 0.9
    # at p1 = 0.8, 0.9, 1, four patches, each with 0.9
# for alpha1 = 0.9:
    # at p1 = 0.5 - 0.8, two patches each with 0.1 and 0.9 specialists
    # as p1 = 0.9, 1, four patches, each with 0.9
