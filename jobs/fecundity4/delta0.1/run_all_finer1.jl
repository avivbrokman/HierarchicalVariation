...
for alpha1 in alpha1s
    for p1 in p1s
        ...
        save_dir = "finer1/hierarchical/fecundity$(fecundity)/delta$(delta)/bimodal/alpha1_$(alpha1)__p1_$(p1)"
...
for pair in pairs_
    for p1 in p1s
        ...
        save_dir = "finer1/hierarchical/fecundity$(fecundity)/delta$(delta)/central_mode__varying_width/alpha1_$(alpha1)__beta1_$(beta1)__p1_$(p1)"
...
for beta1 in beta1s
    for p1 in p1s
        ...
        save_dir = "finer1/hierarchical/fecundity$(fecundity)/delta$(delta)/extreme_mode__varying_mass_everywhere_else/beta1_$(beta1)__p1_$(p1)"
...
for (alpha1, p1s) in pairs(alpha1_p1_combs)
    for p1 in p1s
        ...
        save_dir = "finer1/hierarchical/fecundity$(fecundity)/delta$(delta)/extreme_mode__varying_slope/alpha1_$(alpha1)__p1_$(p1)"
